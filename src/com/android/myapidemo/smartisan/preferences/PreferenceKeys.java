...
public interface PreferenceKeys {
    ...
    static final String PREF_MAX_TABS_IS_PROMPT = "max_tabs_is_prompt";
    ...
    // ----------------------
    // Keys for operation_preferences.xml
    // ----------------------
    static final String PREF_SHAKE_RESTORE = "shake_restore";
    static final String PREF_FIRST_LAUNCH = "first_launch";

    // ----------------------
    // Keys for readmode
    // ----------------------
    static final String PREF_READ_MODE_FONT_SIZE = "readmode_fontsize";
    static final String PREF_READ_MODE_STYLE = "readmode_style";

    // ----------------------
    // Keys for clipboard monitor
    // ----------------------
    static final String PREF_MONITOR_CLICKBOARD = "monitor_clickboard";
    // ----------------------
    // Keys for navigation
    // ----------------------
