...
public class BookmarkUtils {
    ...
    static Bitmap createIcon(Context context, Bitmap touchIcon, Bitmap favicon,
        ...
        final int iconDimension = 0;//am.getLauncherLargeIconSize();
        final int iconDensity = 0;//am.getLauncherLargeIconDensity();
    ...
    /* package */ public static Uri getBookmarksUri(Context context) {
