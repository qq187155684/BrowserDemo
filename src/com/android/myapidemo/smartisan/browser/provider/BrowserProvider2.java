...
package com.android.myapidemo.smartisan.browser.provider;
...
import com.android.myapidemo.smartisan.browser.platformsupport.Browser.BookmarkColumns;
...
import com.android.myapidemo.smartisan.browser.platformsupport.BrowserContract.Bookmarks;
import com.android.myapidemo.smartisan.browser.platformsupport.BrowserContract.ChromeSyncColumns;
...
import com.android.myapidemo.smartisan.browser.platformsupport.BrowserContract.Images;
import com.android.myapidemo.smartisan.browser.platformsupport.BrowserContract.Searches;
import com.android.myapidemo.smartisan.browser.platformsupport.BrowserContract.Settings;
import com.android.myapidemo.smartisan.browser.platformsupport.BrowserContract.SyncState;
...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    public static final String LOGTAG = "BrowserProvider2";
    ...
    public static interface Thumbnails {
        ...
        public static final String THUMBNAIL_LAND = "thumbnail_land";
    }
    ...
    public static final String COLUMN_BACKFORWARD_LIST = "backforwardlist";
    static final String TABLE_THUMBNAIL_CACHE = "thumbnailcache";
    ...
    static final int THUMBNAIL_CACHE = 10000;
    ...
    static final HashMap<String, String> THUMBNAIL_CACHE_MAP = new HashMap<String, String>();
    ...
    static {
        ...
        matcher.addURI(LEGACY_AUTHORITY,
                "bookmarks/" + SearchManager.SUGGEST_URI_PATH_QUERY,
                BOOKMARKS_SUGGESTIONS);
        matcher.addURI(authority, "thumbnailcache", THUMBNAIL_CACHE);
    ...
    public boolean onCreate(){
       /* try {
            Method SetAppOps = ContentProvider.class.getMethod("setAppOps", new Class[] {int.class, int.class});
            Field OP_READ_BOOKMARK = AppOpsManager.class.getDeclaredField("OP_READ_BOOKMARK");
            Field OP_WRITE_BOOKMARK = AppOpsManager.class.getDeclaredField("OP_WRITE_BOOKMARK");
            SetAppOps.invoke(this, new Object[] {OP_READ_BOOKMARK.getInt(this), OP_WRITE_BOOKMARK.getInt(this)});
        } catch (Exception e) {}
*/
    ...
    final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE " + TABLE_HISTORY + "(" +
                    ...
                    ");");
            //update by smartisanos
            //it is used to remember the deleted thumbnial items
        ...
        void createThumbnails(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_THUMBNAILS + " (" +
                    ...
                    Thumbnails.THUMBNAIL_LAND + " BLOB NOT NULL" +
                    ");");
        }
        ...
        public void addNewColumnBackForwardList(SQLiteDatabase db) {
            db.execSQL("ALTER TABLE " + TABLE_THUMBNAIL_CACHE + " ADD COLUMN " + COLUMN_BACKFORWARD_LIST + " BLOB;");
        }
        public void addNewColumnTitle(SQLiteDatabase db) {
            db.execSQL("ALTER TABLE " + TABLE_THUMBNAIL_CACHE + " ADD COLUMN " + History.TITLE + " TEXT;");
        }
        public void addNewColumn(SQLiteDatabase db){
            db.delete(TABLE_THUMBNAILS, null, null);
            db.execSQL("ALTER TABLE thumbnails ADD COLUMN thumbnail_land BLOB;");
        }
        public void createThumbnailTable(SQLiteDatabase db){
            db.execSQL("CREATE TABLE " + TABLE_THUMBNAIL_CACHE + "(" +
                    History._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                    History.URL + " TEXT NOT NULL," +
                    History.DATE_CREATED + " LONG," +
                    COLUMN_BACKFORWARD_LIST + " BLOB," +
                    History.TITLE + " TEXT NOT NULL" +
                    ");");
        }
        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion < 33) {
                ...
                addNewColumn(db);
                addNewColumnBackForwardList(db);
                addNewColumnTitle(db);
            }
        ...
        private void createDefaultBookmarks(SQLiteDatabase db) {
            ...
            if (FEATURE_CMCC != null && FEATURE_CMCC) {
                long cmccId = 0;
                try {
                    String folderName = getContext().getResources().getString(
                            R.string.bookmark_default_folder);
                    values.clear();
                    ...
                    values.put(Bookmarks.POSITION, 0);
                    cmccId = db.insertOrThrow(TABLE_BOOKMARKS, null, values);
                } catch (IllegalStateException e) {
                    Log.e(LOGTAG, "addFolder", e);
                }
                addDefaultBookmarks(db, cmccId);
            }*/
        }
...
//            }
        ...
        switch (match) {
            ...
            case BOOKMARKS_FOLDER: {
                ...
                if (!useAccount) {
                    ...
                    Cursor s = db.query(TABLE_BOOKMARKS, new String[] {
                            Bookmarks._ID
                    }, "PARENT IS NULL ",null,null,null,null);
                    if (s.moveToFirst()) {
                        args = new String[] {
                                Long.toString(s.getLong(0))
                        };
                    } else {
                        args = new String[] {
                                Long.toString(FIXED_ID_ROOT)
                        };
                    }
            ...
            case THUMBNAIL_CACHE:{
                return db.query(TABLE_THUMBNAIL_CACHE, new String[]{"*"}, selection, selectionArgs, null, null, sortOrder);
            }
            case SEARCHES_ID: {
    ...
    public int deleteInTransaction(Uri uri, String selection, String[] selectionArgs,
        ...
        switch (match) {
          ...
          /*  case SYNCSTATE: {
            ...
            case THUMBNAIL_CACHE:
                db.delete(TABLE_THUMBNAIL_CACHE, selection, selectionArgs);
                break;
            default: {
    ...
    public Uri insertInTransaction(Uri uri, ContentValues values, boolean callerIsSyncAdapter) {
        ...
        switch (match) {
            ...
            case THUMBNAIL_CACHE:
                db.insert(TABLE_THUMBNAIL_CACHE, null, values);
                break;
...
*/
    ...
    public int updateInTransaction(Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            ...
            case THUMBNAIL_CACHE:
                db.update(TABLE_THUMBNAIL_CACHE, values, selection, selectionArgs);
                break;

           /* case SYNCSTATE: {
                modified = mSyncHelper.update(mDb, values,selection, selectionArgs);
                break;
            }
