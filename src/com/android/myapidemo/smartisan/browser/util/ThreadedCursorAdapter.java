...
public abstract class ThreadedCursorAdapter<T> extends BaseAdapter {
    ...
    public ThreadedCursorAdapter(Context context, Cursor c) {
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                bindView(view, container.bind_object, container.position);
            }
        };
    }
    ...
    public Cursor getItem(int position) {
        if (mCursorAdapter != null && mCursorAdapter.getCursor() != null) {
            if (mCursorAdapter.getCursor().isClosed()) {
                return null;
            }
        }
...
//                && container.loaded
//                && container.generation == mGeneration) {
//            bindView(convertView, container.bind_object, position);
//        } else {
//            bindView(convertView, cachedLoadObject(), position);
//            // bindView(convertView, cachedLoadObject(), container.position);
//            if (mHasCursor) {
//                container.position = position;
...
//        }
    ...
    public abstract void bindView(View view, T object, int position);
