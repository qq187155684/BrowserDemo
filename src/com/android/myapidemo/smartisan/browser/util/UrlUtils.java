...
import com.android.myapidemo.smartisan.browser.util.SearchEngine;
...
public class UrlUtils {
    ...
    private final static String QUICKSEARCH_BAIDU = "http://m.baidu.com/s?from=1013377a&word=%s";
    private final static String QUICKSEARCH_BING= "http://www.bing.com/search?q=%s";
    private final static String BAIDU_ENGINE_NAME = "baidu";
    private final static String BING_ENGINE_NAME = "bing_zh_CN";
        ...
        if (canBeSearch) {
           /* SearchEngine searchEngine = BrowserSettings.getInstance()
            ...
            if (searchEngine != null) {
                ...
                if (BAIDU_ENGINE_NAME.equalsIgnoreCase(name)) {
                    return URLUtil.composeSearchUrl(inUrl,
                            QUICKSEARCH_BAIDU, QUERY_PLACE_HOLDER);
                } else if (BING_ENGINE_NAME.equalsIgnoreCase(name)) {
                    return URLUtil.composeSearchUrl(inUrl,
                            QUICKSEARCH_BING, QUERY_PLACE_HOLDER);
                }
            }*/
    ...
    /* package */ public static String filteredUrl(String inUrl) {
        if (inUrl == null) {
            return "";
        }
    ...
    public static String alterUrl(String inUrl){
        String tag = "http://";
        String tags = "https://";
        if (inUrl.contains(tag)) {
            inUrl = inUrl.replace(tag, "");
        }else if (inUrl.contains(tags)) {
            inUrl = inUrl.replace(tags, "");
        }
        return inUrl;
    }
}
