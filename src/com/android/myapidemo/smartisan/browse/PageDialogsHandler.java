...
public class PageDialogsHandler {
    ...
    void showSSLCertificateOnError(
        ...
        mSSLCertificateOnErrorDialog = createSslCertificateDialog(cert, error)
                ...
                .show();
        WindowManager.LayoutParams lp = mSSLCertificateOnErrorDialog.getWindow().getAttributes();
        lp.flags |= WindowManager.LayoutParams.FLAG_FULLSCREEN;
        mSSLCertificateOnErrorDialog.getWindow().setAttributes(lp);
    }
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate certificate,
        ...
        if (placeholder == null) {
            placeholder = new LinearLayout(mContext);
            ((ScrollView)certificateView).removeViewAt(0);
            ((ScrollView)certificateView).addView(placeholder);
        }
