...
public class GestureDetector {
    ...
    public interface OnGestureListener {
         ...
         * @param distanceX The distance along the X axis that has been scrolled
         *            since the last call to onScroll. This is NOT the distance
         *            between {@code e1} and {@code e2}.
         * @param distanceY The distance along the Y axis that has been scrolled
         *            since the last call to onScroll. This is NOT the distance
         *            between {@code e1} and {@code e2}.
         * @return true if the event is consumed, else false
         */
    ...
    public interface OnDoubleTapListener {
         ...
         * @param e The motion event that occurred during the double-tap
         *            gesture.
         * @return true if the event is consumed, else false
         */
...
//    private static final int DOUBLE_TAP_MIN_TIME = ViewConfiguration.getDoubleTapMinTime();
    private static final int DOUBLE_TAP_MIN_TIME = DOUBLE_TAP_TIMEOUT >>1;
    ...
    /**
     * Creates a GestureDetector with the supplied listener. You may only use
     * this constructor from a {@link android.os.Looper} thread.
     * @see android.os.Handler#Handler()
    ...
    private void init(Context context) {
        ...
        if (context == null) {
            ...
            doubleTapTouchSlop = touchSlop; // Hack rather than adding a hiden
                                            // method for this
            doubleTapSlop = (Integer) ReflectHelper.invokeStaticMethod(ViewConfiguration.class, "getDoubleTapSlop", null, null);
            // noinspection deprecation
            ...
            doubleTapTouchSlop = (Integer) ReflectHelper.invokeMethod(configuration, "getScaledDoubleTapTouchSlop", null, null);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_UP:
                ...
                // If the pointer that left was opposing another velocity
                // vector, clear.
